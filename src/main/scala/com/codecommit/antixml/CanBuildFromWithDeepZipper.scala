 ...
 * This trait is similar to [[CanBuildFrom]], however its builders accept instances
...
object CanBuildFromWithDeepZipper {
  ...
  /** Implicitly lifts [[CanBuildFrom]] instances into instances of [[CanBuildFromWithDeepZipper]]. The resulting builders simply ignore
